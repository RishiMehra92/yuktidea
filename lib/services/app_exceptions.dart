...
class AlreadyUsedException extends AppException {
  AlreadyUsedException([String? message, String? url]) : super(message, 'Bad request', url);
}

class UnAuthorizedTokenException extends AppException {


  
  UnAuthorizedTokenException([String? message, String? url]) : super(message, 'UnAuthorized request', url);
}